...
class TestKeyboardAPIStatic(TestCase):
    ...
    def test_get_keyboard_no_id(self):
        """Returns primary"""
        keyboard = KeyboardGetUpdateDestroyView.get_keyboard(self.user,
                                              keyboard_id=None)
    ...
    def test_get_keyboard_no_id_no_primary(self):
        ...
        user2 = UserFactory()
        with self.assertRaises(Keyboard.DoesNotExist):
            KeyboardGetUpdateDestroyView.get_keyboard(user2,
                                       keyboard_id=None)
    ...
    def test_get_keyboard_id_not_exist(self):
        with self.assertRaises(Keyboard.DoesNotExist):
            KeyboardGetUpdateDestroyView.get_keyboard(self.user, keyboard_id=99)
