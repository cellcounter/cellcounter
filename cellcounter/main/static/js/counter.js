...
function ironstain() {
    "use strict";
    if ($("#id_ironstain-stain_performed").prop('checked') === true) {
...
function granulopoiesis () {
    "use strict";
    if ($("#id_granulopoiesis-no_dysplasia").prop('checked') === true) {
...
function erythropoiesis () {
    "use strict";
    if ($("#id_erythropoiesis-no_dysplasia").prop('checked') === true) {
...
function megakaryocytes () {
    "use strict";
    if ($("#id_megakaryocyte-no_dysplasia").prop('checked') === true) {
