...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CellImage.thumbnail'
        db.add_column(u'main_cellimage', 'thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CellImage.thumbnail'
        db.delete_column(u'main_cellimage', 'thumbnail')
    ...
    models = {
        ...
        u'main.cellimage': {
            ...
            'celltype': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.CellType']"}),
            'copyright': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.CopyrightHolder']"}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'file': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'license': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.License']"}),
        ...
        u'main.similarlookinggroup': {
            'Meta': {'object_name': 'SimilarLookingGroup'},
            'cell_image': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['main.CellImage']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        }
    }
