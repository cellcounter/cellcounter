...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CellType.visualisation_colour'
        db.add_column('main_celltype', 'visualisation_colour',
                      self.gf('colorful.fields.RGBColorField')(default='', max_length=7, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CellType.visualisation_colour'
        db.delete_column('main_celltype', 'visualisation_colour')
